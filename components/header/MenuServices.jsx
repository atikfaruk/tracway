...
const MenuServices = ({ containerStyles }) => {
  ...
  const styles = {
    ...
    link: "inline-flex",
    item: "group hover:bg-neutral-100 flex items-center gap-4 laptop:gap-2 p-0 pr-7 laptop:pr-6 mobile:pr-0",
    icon: "bg-neutral-100 rounded-lg text-2xl laptop:text-xl mobile:text-base text-neutral-600 group-hover:text-primary group-hover:bg-black/0 transition-colors duration-300 ease-out p-7 laptop:p-6 mobile:p-3",
